var img = {
    "abstratos_geometricos": [302, 171, 130, 120, 206, 136, 0, 138, 73, 300, 19, 66, 125, 202, 301, 21, 129, 59, 132, 118, 55, 116, 119, 77, 205, 78, 131, 139, 203, 107, 121, 124, 117, 10, 20, 204, 72],
    "esculturas_coloridas": [15, 167, 6, 70, 169, 168, 123, 100, 14, 4, 157, 25, 210, 145, 27, 95, 56, 83],
    "esculturas_de_parede": [94, 91, 90],
    "esculturas_aco_corten_ferrugem": [122, 97, 82, 104, 134, 162, 164],
    "ambientes_decorados": [1, 45, 199,151, 192, 177, 22, 181, 51, 42, 153, 312, 92, 113, 185, 190, 40, 53, 37, 179, 49, 197, 2, 36, 311, 180, 35, 208, 188, 13],
    "atelie": [316, 122, 312,318, 314, 313, 317, 315]
}
//   all ------------------
function initInshot() {
    "use strict";
...
function createAlbum() {
    ...
    for(var key in keys) {
        key = keys[key];
        for (var i in img[key]) {
            images.push([key,img[key][i]+".jpg"])
        }
    }
